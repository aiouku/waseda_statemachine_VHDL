...
ENTITY state_machine_behave_test IS
END state_machine_behave_test;

ARCHITECTURE state_machine_behave_test_bench OF state_machine_behave_test IS

    COMPONENT state_machine_behave IS
...
BEGIN
    sm: state_machine_behave PORT MAP(x=>x, clock=>clock, reset=>reset, y=>y);
    ...
    BEGIN
        ...
        WAIT;
    END PROCESS;
END state_machine_behave_test_bench;

CONFIGURATION state_machine_behave_test_conf OF state_machine_behave_test IS
    FOR state_machine_behave_test_bench
    END FOR;
END state_machine_behave_test_conf;